...
local ip=192.168.8.40
local ip_wifi=192.168.8.41
...
sudo networksetup -setmanual "Thunderbolt Ethernet" $ip 255.255.255.0 $server
sudo networksetup -setdnsservers "Thunderbolt Ethernet" $dns_server
